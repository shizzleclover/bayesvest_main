...
from .views import (
    PortfolioGenerateView, PortfolioLatestView, PortfolioHistoryView,
    PortfolioDriftView, PortfolioSimulationView,
)
...
urlpatterns = [
    ...
    path('portfolio/simulate/', PortfolioSimulationView.as_view(), name='portfolio-simulate'),
]
