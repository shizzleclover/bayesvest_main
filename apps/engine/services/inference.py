...
class InferenceEngine:
    ...
    def calculate_risk_score(self, answers):
        ...
        elif horizon == "Short-Term (0-3 years)": total_score += 0
        ...
        elif experience == "Beginner (No experience)": total_score += 0
        ...
        elif income_stability == "Unstable / Unemployed": total_score += 0
        ...
        elif liquidity == "High (May need cash soon)": total_score += 0
        ...
        elif goal == "Capital Preservation": total_score += 0
        ...
        elif debt == "High (Strained)": total_score += 0
        ...
        elif dependents == "3+": total_score += 0
        ...
        elif reaction == "Anxious and want to sell": total_score += 0
        
        # Total possible score = 100
        if total_score <= 25: return 0      # Very Conservative
        elif total_score <= 45: return 1    # Conservative
        elif total_score <= 65: return 2    # Moderate
        elif total_score <= 85: return 3    # Aggressive
        else: return 4                      # Very Aggressive
